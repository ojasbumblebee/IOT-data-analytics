...
os.chdir("/home/ojas/Documents/independent_study_harry_perros/chicago-complete.daily.2018-12-03")
...
try:
    ...
    data_meta_sense_tmp112 = some_node_data.loc[some_node_data['sensor'] == "pr103j2"]
    temp_data_meta_sense_tmp112 = data_meta_sense_tmp112.loc[data_meta_sense_tmp112['parameter'] == "temperature"]
    temp_data_meta_sense_tmp112 = temp_data_meta_sense_tmp112['value_hrf'].astype(float)
    temp_data_meta_sense_tmp112.plot(y='value_hrf', label = "pr103j2", legend = True)
